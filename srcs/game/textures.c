...
/*   Updated: 2025/01/18 14:28:32 by jurodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_game *game)
{
	...
	game->textures->player_img_right[0] = mlx_load_xpm42
		(PLAYER_RIGHT_TEXTURE_1);
	game->textures->player_img_right[1] = mlx_load_xpm42
		(PLAYER_RIGHT_TEXTURE_2);
	...
	if (!game->textures->wall_img || !game->textures->background_img
		...
		ft_printf("ERROR_LOAD_TEXTURES, 1");
}
...
void	convert_textures_two(t_game *game, void *temp)
{
	...
	game->textures->player_img_right[0] = mlx_texture_to_image
		(game->window->mlx, game->textures->player_img_right[0]);
	mlx_delete_xpm42(temp);
	temp = game->textures->player_img_right[1];
	game->textures->player_img_right[1] = mlx_texture_to_image
		(game->window->mlx, game->textures->player_img_right[1]);
	mlx_delete_xpm42(temp);
