...
/*   Updated: 2025/01/13 17:28:51 by jurodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_game *game)
{
	...
	if (!game->textures->wall_img || !game->textures->background_img
		...
		|| !game->textures->player_img_left[0] || !game->textures->player_img_left[1]
		|| !game->textures->player_img_right[0] || !game->textures->player_img_right[1])
