...
/*   Updated: 2025/01/13 15:05:04 by jurodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_images(t_game *game)
{
	...
	if (game->textures->player_img_left[0])
		mlx_delete_image(game->window->mlx, game->textures->player_img_left[0]);
	if (game->textures->player_img_left[1])
		mlx_delete_image(game->window->mlx, game->textures->player_img_left[1]);
	if (game->textures->player_img_right[0])
		mlx_delete_image(game->window->mlx,
			game->textures->player_img_right[0]);
	if (game->textures->player_img_right[1])
		mlx_delete_image(game->window->mlx,
